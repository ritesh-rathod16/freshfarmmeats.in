  ...
  const purposeFeatures = [
    {
      ...
      description: "Minimalist yet impactful, each item brings a sense of calm.",
    },
    {
      icon: "fa-paper-plane fas",
      title: "Balance in Every Detail",
      description: "Intentions in products creates harmony in design and function.",
    },
    {
      icon: "fa-parachute-box fas",
      title: "Soothing Sensory Experience",
      description: "Scents, and aesthetics that engage your senses in a tranquil symphony.",
    },
    {
      icon: "fa-atlas fas",
      title: "Wellness Through Design",
      description: "Thoughtfully created for holistic well-being and mindful living.",
    },
  ];

  const objectivesFeatures = [
    {
      icon: "fa-object-ungroup far",
      title: "Pure Essence Materials",
      description: "Natural elements come together to nurture both body and mind.",
    },
    {
      icon: "fa-paper-plane fas",
      title: "Tranquil Craftsmanship",
      description: "Crafted to bring balance and elegance to your daily rituals.",
    },
    {
      icon: "fa-parachute-box fas",
      title: "Harmonious Aesthetics",
      description: "A seamless fusion of beauty and functionality, for calming designs.",
    },
    {
      icon: "fa-atlas fas",
      title: "Mindful Functionality",
      description: "Designed to align with your lifestyle, ensuring ease of use and comfort.",
    },
  ];
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[460px] overflow-hidden">
          <img 
            ...
            src="https://i.pinimg.com/1200x/a2/5b/a0/a25ba04c52c295be81fa7a22a044c603.jpg" 
            alt="The Meat Barn Farm" 
          />
          <div className="absolute inset-0 bg-black bg-opacity-40"></div>
          <div className="relative container mx-auto px-4 h-full flex items-center">
            <div className="max-w-2xl bg-white bg-opacity-80 p-8 rounded-lg">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Welcome to The Meat Barn</h1>
            ...
            <div className="flex flex-col lg:flex-row items-stretch gap-4">
              ...
              <div className="feature-box p-4">
                <div className="text-center mb-4">
                  <h3 className="text-base font-bold text-gray-800 mb-1">Our Purpose</h3>
                  <p className="text-gray-600 text-s">Harmony between design and function</p>
                </div>
                <div className="space-y-3">
                  {purposeFeatures.map((feature, idx) => (
                    <div key={idx}>
                      <div className="flex items-center gap-2">
                        <span className="purpose-icon feature-icon w-8 h-8 text-sm flex-shrink-0 flex justify-center items-center">
                          <i className={`${feature.icon}`}></i>
                        </span>
                        <span className="text-sm font-semibold text-gray-800">{feature.title}</span>
                      </div>
                      <p className="text-gray-600 text-xs ml-10">{feature.description}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Center Image */}
              <div className="center-image-container flex items-center my-2 lg:my-0">
                <img
                  src="https://goatwala.com/wp-content/uploads/2025/05/053-IMG_3485-removebg-preview.png"
                  alt="Goatwala Farm"
                  className="center-image rounded-md w-64 md:w-96 mx-auto"
                />
              </div>
              ...
              <div className="feature-box p-4">
                <div className="text-center mb-4">
                  <h3 className="text-base font-bold text-gray-800 mb-1">Our Objectives</h3>
                  <p className="text-gray-600 text-s">Aesthetics with purpose</p>
                </div>
                <div className="space-y-3">
                  {objectivesFeatures.map((feature, idx) => (
                    <div key={idx}>
                      <div className="flex items-center gap-2">
                        <span className="objectives-icon feature-icon w-8 h-8 text-sm flex-shrink-0 flex justify-center items-center">
                          <i className={`${feature.icon}`}></i>
                        </span>
                        <span className="text-sm font-semibold text-gray-800">{feature.title}</span>
                      </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-800">Breeds at The Meat Barn Farm</h2>
              <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
                The Meat Barn  Farm, situated in Sundrel, Madhya Pradesh, is the oldest goat farm in India and a leading institute dedicated to goat farming in Central India.
              </p>
            </div>
